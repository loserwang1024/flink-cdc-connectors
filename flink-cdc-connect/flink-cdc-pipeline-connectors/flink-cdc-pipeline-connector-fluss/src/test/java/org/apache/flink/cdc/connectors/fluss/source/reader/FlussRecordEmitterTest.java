...
class FlussRecordEmitterTest {
    ...
    void testSchemaChangeDetectedAfterStateRestoration() throws Exception {
        ...
        // Expect: CreateTableEvent (from pending) + AddColumnEvent (from schema change) +
        // DataChangeEvent
    ...
    void testSecondRecordDoesNotReEmitCreateTableEvent() throws Exception {
        ...
        // First record — emits pending CreateTableEvent
    ...
    void testCreateTableEventContainsPrimaryKey() throws Exception {
        ...
        FlussLogSplit split =
                new FlussLogSplit(PHYSICAL_TABLE_PATH, TABLE_BUCKET, 100L, 1, rt, primaryKeyNames);
