...
import static com.ververica.cdc.connectors.base.options.SourceOptions.SCAN_INCREMENTAL_SNAPSHOT_BACKFILL_ENABLED;
...
public class PostgreSQLTableFactory implements DynamicTableSourceFactory {
    ...
    public DynamicTableSource createDynamicTableSource(DynamicTableFactory.Context context) {
        ...
        boolean backfillEnabled = config.get(SCAN_INCREMENTAL_SNAPSHOT_BACKFILL_ENABLED);
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        ...
        options.add(SCAN_INCREMENTAL_SNAPSHOT_BACKFILL_ENABLED);
        return options;
    }
